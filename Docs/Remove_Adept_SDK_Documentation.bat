...
REM Help Viewer 1.0
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Synergis Technologies LLC" /productName "Synergis Adept 2018 SDK" /mediaBookList "Synergis Adept 2018 SDK"
...
REM Help Viewer 2.x
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation uninstall /vendor "Synergis Technologies LLC" /productName "Synergis Adept 2018 SDK" /bookList "Synergis Adept 2018 SDK"
