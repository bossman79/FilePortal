...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Synergis Technologies LLC" /productName "Synergis Adept 2018 SDK" /mediaBookList "Synergis Adept 2018 SDK" > NUL
...
REM build time.
IF EXIST "Adept_SDK_Documentation.msha" COPY /Y "Adept_SDK_Documentation.msha" HelpContentSetup.msha
...
REM Uninstall first in case it is already there.  If not, it won't install below.  We'll ignore any error output
REM by redirecting it to NUL.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation uninstall /vendor "Synergis Technologies LLC" /productName "Synergis Adept 2018 SDK" /bookList "Synergis Adept 2018 SDK" > NUL

REM Install the new content.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation install /sourceUri "%CD%\Adept_SDK_Documentation.msha"
